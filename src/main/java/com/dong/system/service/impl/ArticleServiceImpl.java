...
import com.dong.lucene.luceneUtils;
import com.dong.system.entity.*;
import com.dong.system.mapper.ArticleMapper;
import com.dong.system.mapper.ArttypeMapper;
import com.dong.system.service.*;
...
public class ArticleServiceImpl extends ServiceImpl<ArticleMapper, Article> implements IArticleService {
    ...
    public Map<String,Object> insert(Article article) throws IOException {
      Map<String, Object> map = new HashMap<>();
        ...
        article.setCreateuserid(ShiroUtils.getUser().getUserId());
        System.err.println("=======ShiroUtils.getUser().getUserId()："+ShiroUtils.getUser().getUserId());
        article.setJf(0);
    ...
    public Model indexModel(Model model){
        ...
        List<Arttype> Arttypes = iArttypeService.list(
                new QueryWrapper<Arttype>().eq("parentid", url.get(0).getActtypeId()).eq("state",1));

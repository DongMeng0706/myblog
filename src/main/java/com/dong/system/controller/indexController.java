...
import com.dong.common.aspect.Log;
import com.dong.shiro.SessionListenersUser;
...
public class indexController {
    ...
    public String main(Model model){
        ...
        model.addAttribute("list",logService.list(new QueryWrapper<com.dong.system.entity.Log>().orderByDesc("createtime").last("limit 0,8")));
